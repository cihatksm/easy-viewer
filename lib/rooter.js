...
class Rooter {
    ...
    run(data, content) {
        ...
        const compiled = compile(content, { doubleBraceRaw: config.get(config.names.doubleBraceRaw) });
        ...
        const includeResolverSync = (file) => {
            ...
            try {
                ...
                const compiledChild = compile(fileContent, { doubleBraceRaw: config.get(config.names.doubleBraceRaw) });
